...
parser.add_argument("-score_path", "--score_path", help="Path to save calculated scores and index.", default='./bpr_score_index_bak/')
...
#     np.save('./bpr_score_index_bak/st1000_' + data_train +'.npy', st1000)
